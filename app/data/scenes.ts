...
export const mapNodes = [
  { id: "start",           label: "광주역",   x: 25,  y: 62,  connections: ["university_gate", "call_family", "observe_street"] },
  { id: "observe_street",  label: "거리",     x: 48,  y: 46,  connections: ["university_gate", "radio_room"] },
  { id: "university_gate", label: "전남대",   x: 75,  y: 18,  connections: ["record_scene", "downtown", "talk_students"] },
  { id: "talk_students",   label: "학생들",   x: 105, y: 10,  connections: ["downtown", "record_scene"] },
  { id: "call_family",     label: "공중전화", x: 18,  y: 82,  connections: ["radio_room", "downtown"] },
  { id: "radio_room",      label: "집",       x: 38,  y: 94,  connections: ["record_scene", "citizen_voice"] },
  { id: "record_scene",    label: "기록",     x: 120, y: 40,  connections: ["citizen_voice", "help_people"] },
  { id: "downtown",        label: "금남로",   x: 135, y: 60,  connections: ["citizen_voice", "help_people", "record_scene"] },
  { id: "citizen_voice",   label: "도청앞",   x: 158, y: 36,  connections: ["community", "help_people"] },
  { id: "help_people",     label: "시내",     x: 150, y: 74,  connections: ["community", "outside_message"] },
  { id: "community",       label: "공동체",   x: 175, y: 52,  connections: ["last_night", "archive_ending"] },
  { id: "outside_message", label: "외곽",     x: 168, y: 92,  connections: ["archive_ending", "last_night"] },
  { id: "last_night",      label: "도청",     x: 195, y: 34,  connections: ["memory_ending"] },
  { id: "archive_ending",  label: "기록관",   x: 202, y: 78,  connections: [] },
  { id: "memory_ending",   label: "현재",     x: 225, y: 56,  connections: [] },
];
