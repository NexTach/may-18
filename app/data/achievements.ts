...
export type AchievementDef = {
  ...
  description: string;
  hint: string;
  condition: (p: GameProgress) => boolean;
};
...
export const achievementDefs: AchievementDef[] = [
  ...
  },
  {
    ...
    condition: (p) => p.stats.record >= 3 && p.stats.courage >= 3,
  },
  {
    id: "witness",
    icon: "◆",
  ...
  },
  {
    ...
    condition: (p) => visited(p).has("university_gate"),
  },
  {
    id: "heard_radio",
    icon: "♫",
    ...
    condition: (p) => visited(p).has("radio_room"),
  },
  {
    id: "helper",
    icon: "✚",
  ...
  },
  {
    ...
    condition: (p) => visited(p).has("outside_message"),
  },
  {
    id: "last_witness",
    icon: "◐",
    ...
    condition: (p) => visited(p).has("last_night"),
  },
  ...
  // ── 엔딩 기반 ─────────────────────────────────────────────────────
  {
    ...
    condition: (p) => visited(p).has("archive_ending"),
  },
  {
    id: "memory_keeper",
    icon: "★",
    ...
    condition: (p) => visited(p).has("memory_ending"),
  },
];
