...
export default function MapModal({ currentSceneId, visitedSceneIds, choiceLog, onClose }: Props) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        {/* map */}
        <div className="border border-[#2c3f12] bg-[#090d06] mb-4" style={{ height: 280 }}>
          <MiniMap
        ...
        <div className="flex items-center gap-5 mt-3">
          {[
            ...
            <div key={label} className="flex items-center gap-1.5">
              ...
              <span className="text-[12px] text-[#3a5010]" style={{ fontFamily: "monospace" }}>{label}</span>
            </div>
          ))}
          <div className="flex items-center gap-1.5">
            <span className="text-[12px] text-[#4a6a1a]" style={{ fontFamily: "monospace" }}>- - -</span>
            <span className="text-[12px] text-[#3a5010]" style={{ fontFamily: "monospace" }}>경로</span>
          </div>
        </div>
      </div>
    </div>
